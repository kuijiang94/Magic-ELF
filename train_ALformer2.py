...
opt = Config('training_ALformer2.yml')
...
#from STAN import STAN #STRN_64_10
from ALformer_lw import ALformer
...
file1 = 'ALformer2_PAR.txt'
file2 = 'ALformer2_PSNR.txt'
file3 = 'ALformer2_LOSS.txt'
######### Set Seeds ###########
random.seed(1234)
np.random.seed(1234)
